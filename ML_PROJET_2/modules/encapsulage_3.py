...
class Sequential(module.Module):
    ...
    def add_module(self, module: module.Module):
        assert isinstance(module, module.Module), 'The module object must be an instance of the Module class'
...
def SGD(net: module.Module, loss: loss.Loss, eps: float, X: np.ndarray, y: np.ndarray, 
